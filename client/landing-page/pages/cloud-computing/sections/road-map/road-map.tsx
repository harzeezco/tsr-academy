...
export function RoadMap() {
  ...
  return (
    <Container
      ...
      className='py-14'
      style={{
        background: 'radial-gradient(circle, #F2FEFF 50%, #EDF7F7)',
      }}
      variant='outer'
    >
      ...
      <div className='relative mt-20'>
        <Image
          alt=''
          className='absolute left-0 max-sm:h-[50px] max-sm:w-[80px] sm:h-[100px] sm:w-[90px]'
          height={123}
        ...
        <Image
          alt=''
          className='absolute left-0 top-28 max-sm:h-[50px] max-sm:w-[80px] sm:size-[80px] lg:top-52 lg:w-[150px]'
          height={123}
        ...
        <div className='relative mx-auto grid max-w-[824px] place-items-center border-t border-black/10'>
          ...
          <h1 className='absolute bottom-2 text-xl font-medium text-white sm:bottom-6 sm:text-4xl lg:bottom-6 lg:text-5xl'>
            Your Journey
          </h1>
        </div>
        ...
        <Image
          alt=''
          className='absolute right-0 top-0 max-sm:h-[50px] max-sm:w-[80px] sm:h-[80px] sm:w-[90px] lg:top-10 lg:w-[150px]'
          height={123}
        ...
        <Image
          alt=''
          className='absolute right-0 top-28 max-sm:h-[50px] max-sm:w-[60px] sm:h-[100px] sm:w-[90px] lg:top-52'
          height={123}
      ...
      <div className='mx-auto mt-14 max-w-2xl grid-cols-[auto_1fr] items-center justify-center gap-7 px-2 max-sm:grid md:mt-20 md:flex'>
        ...
        <div className='relative'>
          ...
          <Image
            alt=''
            className='absolute left-14 top-2 max-sm:h-[85px] max-sm:max-w-[150px] md:left-12 md:top-3 md:object-cover lg:left-10 lg:!max-w-[450px]'
            height={192}
