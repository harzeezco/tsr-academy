    ...
    >
      <div className='mx-auto max-w-[1000px]'>
        ...
        >
          ...
          <blockquote className='mt-3 max-w-5xl text-xl font-bold md:text-4xl md:leading-[45px]'>
            Demand for DevOps experts is growing rapidly with a 23.1%
            year-over-year increase in the past 12 months. The typical
            turnover rate for employees with these skills is 42%, which
            indicates a positive career outlook for cloud professionals.
          </blockquote>
        </article>
        ...
        >
          <div className=''>
            ...
            <p className='my-3 text-3xl font-semibold md:text-4xl lg:text-6xl'>
              $
