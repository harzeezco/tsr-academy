...
const sharedClasses =
  'grid grid-cols-1 md:grid-cols-[260px_1fr] gap-y-7 place-items-center bg-white px-2 lg:min-w-[900px] w-full mx-auto rounded-[30px] gap-x-10 py-3 border border-[#676C75] border-solid';
