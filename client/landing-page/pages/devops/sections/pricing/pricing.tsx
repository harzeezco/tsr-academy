...
const pricingList: PricingProps[] = [
  {
    ...
    btnClasses: 'hover:bg-primary hover:text-white',
  ...
  },
  {
    ...
    btnClasses: 'text-white hover:bg-primary',
    footerText: '2 spots left for this cohort ',
  },
];
...
export function Pricing() {
  return (
    <Container
      className='px-2 py-14 lg:px-7'
      style={{ background: '#F8FFFE' }}
      variant='outer'
    >
      <h1 className='mx-auto text-center text-4xl text-[#105DBD] md:text-6xl'>
        Simple Pricing
      </h1>
      ...
      <ul className='mt-10 flex items-center justify-center gap-10 max-lg:flex-col'>
        {pricingList.map((item) => (
          ...
          >
            ...
            <div className='rounded-t-[24px] bg-[#EBF4FF] p-5'>
              <Image
                alt=''
                className=''
                height={53}
            ...
            <div
              className='flex items-center justify-center rounded-b-[24px] py-4 text-xl font-medium text-white'
              style={{
                background:
                  'linear-gradient(to right, #024ba5, #105dbd)',
              }}
